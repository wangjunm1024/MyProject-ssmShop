			   ...
			   <tr bgcolor="#E7E7E7">
				...
				<tr>
					...
					<td class="ta_01" bgColor="#FFFFFF">
						<input type="text" name="pname" value="<s:property value="model.pname"/>" id="adminProductAction_save_do_logonName"/>
					</td>
				...
				<tr>
					...
					<td class="ta_01" bgColor="#FFFFFF">
						<input type="text" name="market_price" value="<s:property value="model.market_price"/>" id="adminProductAction_save_do_logonName"/>
					</td>
					<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
						商城价格：
					</td>
					<td class="ta_01" bgColor="#FFFFFF">
						<input type="text" name="shop_price" value="<s:property value="model.shop_price"/>" id="adminProductAction_save_do_logonName"/>
					</td>
				</tr>
				<tr>
					<td width="18%" align="center" bgColor="#f5fafe">
