...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body leftmargin="2" topmargin="9" background='<%=path %>/images/allbg.gif'>
		<form id="categorySecondAction_save_do" action="<%=path %>/adminCategorySecond_update" name="formAdd" method="post">
			     ...
			     <table width="98%" align="center" border="0" cellpadding="4" cellspacing="1" bgcolor="#CBD8AC" style="margin-bottom:8px">
					...
					<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='red';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
					    ...
					    <td width="40%" bgcolor="#FFFFFF" align="left">
					        <input type="text" name="csname" value="<s:property value="model.csname"/>" id="categorySecondAction_save_do_logonName" size="20"/>
					    </td>
					    <td width="10%" bgColor="#FFFFFF" align="left">
						所属的一级分类：
						</td>
						<td width="40%" bgColor="#FFFFFF" >
							<select name="cid" style="width:60%">
								<s:iterator var="c" value="cList">
									<option value="<s:property value="#c.cid"/>" <s:if test="#c.cid==model.cid">selected</s:if>><s:property value="#c.cname"/></option>
								</s:iterator>
							</select>
						</td>
					</tr>
