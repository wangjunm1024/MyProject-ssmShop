...
function checkForm(){
	...
	if(obj.val() === ""){ //输入不能为空
	   alert("邮箱不能为空!");
	   return false;
	}else if(!myreg.test(obj.val())){ //正则验证不通过，格式不对
	   alert("邮箱格式不正确！");
	   return false;
	}
}
	...
	<div class="span5">
		<div class="logo">
			<%-- <a href="http://localhost:8080/mango/">
				<img src="${pageContext.request.contextPath}/image/r___________renleipic_01/logo.gif" alt="宣城实训项目" />
			</a> --%>
		</div>
	</div>
	<div class="span9">
		...
		<div class="span24">
			<div class="wrap">
				<div class="main clearfix">
					...
					<form id="registerForm" action="${ pageContext.request.contextPath }/user_regist.action" method="post" onsubmit="return checkForm();">
						<table>
							<tbody><tr>
								<th>
								...
								<td>
									<input type="text" id="username" name="username" class="text" maxlength="20" onblur="checkUsername(this.value)"/>
									<span id="span1"></span>
							...
							<tr>
								...
								<td>
									...
									<span><s:fielderror fieldName="repassword"></s:fielderror></span>
								</td>
							</tr>
							<tr>
								<th>
